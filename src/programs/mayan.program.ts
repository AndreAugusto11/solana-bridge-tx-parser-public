export declare type Mayan = {
	...
	metadata: { name: "swift"; version: "0.1.0"; spec: "0.1.0" };
	instructions: [
		{
			name: "registerOrder";
			accounts: [
		...
		},
		{
			...
			accounts: [
				...
				{ name: "stateToAcc"; isMut: false; isSigner: false },
				{ name: "mintTo"; isMut: false; isSigner: false },
				{
					name: "dest";
					isMut: true;
					isSigner: false;
		...
		},
		{
			...
			accounts: [
				{ name: "state"; isMut: true; isSigner: false },
				{ name: "stateToAcc"; isMut: true; isSigner: false },
				{ name: "relayer"; isMut: true; isSigner: true },
				{ name: "mintTo"; isMut: false; isSigner: false },
		...
		},
		{
			...
			accounts: [
				{ name: "driver"; isMut: true; isSigner: true },
				{ name: "emitter"; isMut: false; isSigner: false },
				{ name: "config"; isMut: true; isSigner: false },
				{ name: "emitterSequence"; isMut: true; isSigner: false },
				{ name: "feeCollector"; isMut: true; isSigner: false },
				{ name: "message"; isMut: true; isSigner: true },
				{ name: "coreBridgeProgram"; isMut: false; isSigner: false },
				{ name: "systemProgram"; isMut: false; isSigner: false },
		...
		},
		{
			...
			accounts: [
				...
				{ name: "relayer"; isMut: true; isSigner: true },
				{ name: "state"; isMut: true; isSigner: false },
				{ name: "stateFromAcc"; isMut: false; isSigner: false },
				{ name: "relayerFeeAcc"; isMut: true; isSigner: false },
				{ name: "mintFrom"; isMut: false; isSigner: false },
				{ name: "feeManagerProgram"; isMut: false; isSigner: false },
				{ name: "tokenProgram"; isMut: false; isSigner: false },
				{ name: "systemProgram"; isMut: false; isSigner: false },
			];
		...
		},
		{
			name: "unlockBatch";
			accounts: [
				{ name: "vaaUnlock"; isMut: false; isSigner: false },
				{ name: "state"; isMut: true; isSigner: false },
				{ name: "stateFromAcc"; isMut: true; isSigner: false },
				{ name: "mintFrom"; isMut: false; isSigner: false },
				{ name: "driver"; isMut: true; isSigner: true },
				{ name: "driverAcc"; isMut: true; isSigner: false },
				{ name: "tokenProgram"; isMut: false; isSigner: false },
				{ name: "systemProgram"; isMut: false; isSigner: false },
			];
		...
		},
		{
			name: "refund";
			accounts: [
				{ name: "vaaCancel"; isMut: false; isSigner: false },
				{ name: "state"; isMut: true; isSigner: false },
				{ name: "stateFromAcc"; isMut: true; isSigner: false },
				{ name: "trader"; isMut: true; isSigner: false },
				{
					name: "traderAcc";
					isMut: true;
					isSigner: false;
				...
				{ name: "mintFrom"; isMut: false; isSigner: false },
				{ name: "relayerRefund"; isMut: true; isSigner: true },
				{ name: "relayerRefundAcc"; isMut: true; isSigner: false },
				{ name: "relayerCancel"; isMut: false; isSigner: false },
				{ name: "relayerCancelAcc"; isMut: true; isSigner: false },
				{ name: "tokenProgram"; isMut: false; isSigner: false },
				{ name: "systemProgram"; isMut: false; isSigner: false },
			];
	...
	accounts: [
		{
			...
			type: {
				...
				fields: [
					{ name: "bump"; type: "u8" },
					{ name: "status"; type: { defined: "SwiftDestSolanaStatus" } },
					{ name: "order"; type: { defined: { generics: []; name: "OrderInfo" } } },
					{ name: "hash"; type: { array: ["u8", 32] } },
					{ name: "relayer"; type: "pubkey" },
					{ name: "fulfill"; type: { defined: "FulfillInfo" } },
				];
			};
		},
		{
		...
		},
		{
			...
			type: {
				...
				fields: [
					...
					{ name: "closeEpoch"; type: "u64" },
					{ name: "amountOutMin"; type: "u64" },
					{ name: "winner"; type: "pubkey" },
					{ name: "amountPromised"; type: "u64" },
					{ name: "validFrom"; type: "u64" },
	...
	types: [
		{
			...
			type: {
				kind: "struct";
				fields: [
					{ name: "amountInMin"; type: "u64" },
					{ name: "nativeInput"; type: "bool" },
					{ name: "feeSubmit"; type: "u64" },
					{ name: "addrDest"; type: { array: ["u8", 32] } },
					{ name: "chainDest"; type: "u16" },
					{ name: "tokenOut"; type: { array: ["u8", 32] } },
					{ name: "amountOutMin"; type: "u64" },
					{ name: "gasDrop"; type: "u64" },
					{ name: "feeCancel"; type: "u64" },
					{ name: "feeRefund"; type: "u64" },
					{ name: "deadline"; type: "u64" },
					{ name: "addrRef"; type: { array: ["u8", 32] } },
					{ name: "feeRateRef"; type: "u8" },
					{ name: "feeRateMayan"; type: "u8" },
					{ name: "auctionMode"; type: "u8" },
					{ name: "keyRnd"; type: { array: ["u8", 32] } },
				];
			};
		},
		{
			...
			type: {
				...
				fields: [
					{ name: "winner"; type: "pubkey" },
					{ name: "amountPromised"; type: "u64" },
					{ name: "amountOutput"; type: "u64" },
					{ name: "patchVersion"; type: "u8" },
					{ name: "timeFulfill"; type: "u64" },
					{ name: "addrUnlocker"; type: { array: ["u8", 32] } },
				];
			};
		},
		{
		...
		},
		{
			...
			type: {
				kind: "enum";
				variants: [{ name: "NONE" }, { name: "LOCKED" }, { name: "UNLOCKED" }, { name: "REFUNDED" }];
			};
		},
		{
			name: "OrderInfo";
			type: {
				kind: "struct";
				fields: [
					{ name: "trader"; type: { array: ["u8", 32] } },
					{ name: "chainSource"; type: "u16" },
					{ name: "tokenIn"; type: { array: ["u8", 32] } },
					{ name: "addrDest"; type: { array: ["u8", 32] } },
					{ name: "chainDest"; type: "u16" },
					{ name: "tokenOut"; type: { array: ["u8", 32] } },
					{ name: "amountOutMin"; type: "u64" },
	...
	errors: [
		...
		{ code: 6012; name: "InvalidMint"; msg: "Invalid mint" },
		{
			code: 6013;
		...
		{ code: 6021; name: "Overflow"; msg: "Overflow" },
		{
			code: 6022;
		...
		{ code: 6024; name: "AmountInTooSmall"; msg: "Amount in too small" },
		{ code: 6025; name: "InvalidZeroAmount"; msg: "Invalid zero amount" },
		{
			code: 6026;
		...
		{ code: 6032; name: "InvalidParam"; msg: "Invalid order parameter" },
		{
			code: 6033;
			name: "FeesOverflow";
		...
		{ code: 6038; name: "InvalidUnlockVAA"; msg: "Invalid unlock vaa" },
		{
			code: 6039;
		...
		{ code: 6041; name: "InvalidRemainingAccountsCount" },
		{ code: 6042; name: "InvalidTokenAccountMint" },
		{ code: 6043; name: "InvalidTokenAccountOwner" },
		{ code: 6044; name: "InvalidEmitterChain" },
		{ code: 6045; name: "InvalidEmitterAddress" },
		{ code: 6046; name: "InvalidCancelVAA"; msg: "Invalid cancel vaa" },
		{ code: 6047; name: "WrongCancelRelayerAddress" },
		{ code: 6048; name: "InsufficientFundsToRefundFee" },
		{ code: 6049; name: "InvalidTrader" },
		{ code: 6050; name: "InvalidOneOwner" },
		{ code: 6051; name: "InvalidTwoOwner" },
		{ code: 6052; name: "InvalidThreeOwner" },
	];
};
